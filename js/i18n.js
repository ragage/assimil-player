...
const STRINGS = {
  en: {
    ...
    /* Welcome ----------------------------------------------------------- */
    'welcome.heading': 'Choose a language',
    ...
    'welcome.emptyTitle': 'No languages yet',
    ...
    'welcome.addLanguage': '+ Add a language',
    ...
    'course.emptyBody': 'Add the MP3 files for this language. They are copied into the app so they play with no connection.',
    ...
    'aria.backToLanguages': 'Back to languages',
    ...
    /* Course dialog ----------------------------------------------------- */
    'dialog.addLanguage': 'Add a language',
    'dialog.editLanguage': 'Edit language',
    ...
    'toast.nowAddFiles': 'Now add the MP3 files for this language.',
  ...
  fr: {
    ...
    /* Accueil ----------------------------------------------------------- */
    'welcome.heading': 'Choisissez une langue',
    ...
    'welcome.emptyTitle': 'Aucune langue pour l’instant',
    ...
    'welcome.addLanguage': '+ Ajouter une langue',
    ...
    'course.emptyBody': 'Ajoutez les fichiers MP3 de cette langue. Ils sont copiés dans l’application afin d’être lus sans connexion.',
    ...
    'aria.backToLanguages': 'Retour aux langues',
    ...
    'dialog.addLanguage': 'Ajouter une langue',
    'dialog.editLanguage': 'Modifier la langue',
    ...
    'toast.nowAddFiles': 'Ajoutez maintenant les fichiers MP3 de cette langue.',
